...
const questionsADHD = [
  'Как часто у вас возникают проблемы с доведением дела до конца, когда самая сложная часть сделана?',
  'Как часто у вас возникают трудости с приведением дел в порядок, когда задача требует организации?',
  'Как часто у вас возникают проблемы с запоминанием назначенных встреч или обещаний?',
  'Когда перед вами стоит задача, требующая много размышлений, как часто вы её избегаете или откладываете?',
  'Как часто вы ерзаете или дёргаете руками или ногами, когда вам приходится долго сидеть?',
  'Как часто вы чувствуете себя чрезмерно активными и испытываете нужду делать что-то, словно внутри вас заведенный мотор?',
  'Как часто вы совершаете неосторожные ошибки, когда приходится работать над скучным или сложным проектом?',
  'Как часто вы испытываете трудности с внимательностью, когда делаете скучную или повторяющуюся работу?',
  'Как часто вам сложно сосредоточиться на том, что люди говорят вам, даже когда они говорят с вами напрямую?',
  'Как часто вы кладёте вещи не на свои места или с трудом находите их дома/на работе?',
  'Как часто вы отвлекаетесь активностью или шумом вокруг?',
  'Как часто вы покидаете свое место на собраниях или в других ситуациях, в которых ожидается, что вы останетесь сидеть?',
  'Как часто вы чувствуете себя неусидчиво и неугомонно?',
  'Как часто вы испытываете трудности с отдыхом и расслаблением, когда у вас есть время для себя?',
  'Как часто вы замечаете, что слишком много говорите, когда находитесь в социальных ситуациях?',
  'Как часто вы заканчиваете предложения людей, с которыми разговариваете, прежде чем они смогут закончить их сами?',
  'Как часто вам с трудом удаётся дожидаться своей очереди?',
  'Как часто вы прерываете других, когда они заняты?',
]

questionsADHD.name = 'Тестування СДВГ (ADHD)'
questionsADHD.answers = ['Никогда', 'Редко', 'Иногда', 'Часто', 'Очень часто']

questionsADHD.keyAD = [1, 2, 3, 4, 7, 8, 9, 10, 11]
questionsADHD.keyHD = [5, 6, 12, 13, 14, 15, 16, 17, 18]

questionsADHD.description = `<p>Adult ADHD Self-Report Scale (ASRS) шкала для диагностики СДВГ у взрослых, разработанная совместно со Всемирной организацией здравоохранения (ВОЗ) и исследователями из Медицинской школы Нью-Йоркского университета и Гарвардской медицинской школы. Оценка идет по двум шкалами: Дефицита Внимания и Гиперактивности, а также подсчитывается общий показатель.</p><br><br>

<p>Инструкция к тесту: Ответьте на приведенные ниже вопросы исходя из того, как прошли ваши последние 6 месяцев</p>`
